...
MIDDLEWARE = [
    ...
    'apps.core.jwt_auth_middleware.JWTAuthMiddleware',
...
STATIC_URL = '/static/'
# Файлы в apps/core/static/ — подхватывает AppDirectoriesFinder (без дублей с STATICFILES_DIRS)
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Home AI API',
    'DESCRIPTION': (
        'Распределённый REST API для планирования домашних дел '
        'с нейросетевой генерацией подзадач (YandexGPT)'
    ),
    'VERSION': '1.0.0',
}
